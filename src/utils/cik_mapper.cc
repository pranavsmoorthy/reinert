...
std::string CIKMapper::PadCIK(const std::string& raw_cik) const {
...
bool CIKMapper::Load(const std::string& filepath) {
...
std::string CIKMapper::GetCIK(const std::string& ticker) const {
